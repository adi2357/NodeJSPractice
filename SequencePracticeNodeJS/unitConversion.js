...
const INCHES_TO_FEET_CONVERSION_UNIT = 1/12;

let inches = 42;
let feet = inches * INCHES_TO_FEET_CONVERSION_UNIT;
...
console.log("Plot Dimension in Meters : " + lengthInMeters.toFixed(2) 
          + " meters X " + breadthInMeters.toFixed(2) + " meters");

//Calculate area of 25 such 60 feet x 40 feet plots in acres
